---
description: Cria PRDs (Product Requirements Documents) claros e acionáveis a partir de solicitações de funcionalidade
user_invocable: true
---
...
<critical>NÃO GERE O PRD SEM ANTES FAZER PERGUNTAS DE CLARIFICAÇÃO. Use askUserQuestion</critical>
...
- Template fonte: `./assets/prd-template.md` (relativo a esta skill)
- Nome do arquivo final: `prd.md`
- Diretório final: `dev/[nome-funcionalidade]/` (nome em kebab-case, na raiz do projeto)
- Exemplo: `dev/fin-control-creation/prd.md`
...
- Use o template em `./assets/prd-template.md`
...
- Crie o diretório: `dev/[nome-funcionalidade]/`
- Salve o PRD em: `dev/[nome-funcionalidade]/prd.md`
...
- [ ] Arquivo salvo em `dev/[nome-funcionalidade]/prd.md`
